...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? TeachersWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: AdminskillWidget.routeName,
          path: AdminskillWidget.routePath,
          requireAuth: true,
          builder: (context, params) => AdminskillWidget(
            classDiv: params.getParam(
              'classDiv',
              ParamType.String,
            ),
